...
public class BuyerOrderController {
    ...
    // 订单列表
    @GetMapping("/list")
    public ResultVO<List<OrderDTO>> list(String openid, @RequestParam(defaultValue = "0") Integer page,
        ...
        List<OrderDTO> orderDTOList = orderService.findList(openid, request).getContent();
